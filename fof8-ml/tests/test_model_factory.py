...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("catboost_regressor_tweedie", "regressor", CatBoostRegressorWrapper),
        ("catboost_regressor_rmse", "regressor", CatBoostRegressorWrapper),
        ("catboost_regressor_mae", "regressor", CatBoostRegressorWrapper),
        ("catboost_regressor_expectile", "regressor", CatBoostRegressorWrapper),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("catboost_regressor_tweedie.yaml", "regressor", CatBoostRegressorWrapper),
        ("catboost_regressor_rmse.yaml", "regressor", CatBoostRegressorWrapper),
        ("catboost_regressor_mae.yaml", "regressor", CatBoostRegressorWrapper),
