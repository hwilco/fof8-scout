...
from fof8_ml.orchestration.types import PreparedData, Stage1Result
...
class ExperimentLogger:
    ...
    def log_data_summary(
        ...
        try:
            ...
            relative_data_path = os.path.relpath(absolute_raw_path, self.exp_root)
    ...
    def write_dvc_metrics(self, metric_name: str, score: float) -> None:
        """Write the optimization metric to outputs/metrics.json for DVC."""
        try:
