...
import hydra
from fof8_ml.orchestration.phase4_matrix import run_phase4_matrix
...
@hydra.main(version_base=None, config_path="conf", config_name="phase4_matrix_pipeline")
def main(cfg: DictConfig) -> int:
    result = run_phase4_matrix(cfg, exp_root=resolve_exp_root(__file__))
    print(
        "Phase 4 matrix complete: "
