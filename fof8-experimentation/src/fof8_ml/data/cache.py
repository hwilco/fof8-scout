...
def get_data_hash(cfg, year_range=None):
    ...
    if "raw_path" in relevant_keys["data"]: del relevant_keys["data"]["raw_path"]
    if "cache_dir" in relevant_keys["data"]: del relevant_keys["data"]["cache_dir"]
    if "include_features" in relevant_keys["data"]: del relevant_keys["data"]["include_features"]
    if "exclude_features" in relevant_keys["data"]: del relevant_keys["data"]["exclude_features"]
    if "mask_positional_features" in relevant_keys["data"]: del relevant_keys["data"]["mask_positional_features"]
