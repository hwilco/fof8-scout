...
def main(cfg: DictConfig):
    ...
    available_years = sorted([
        int(p.name) for p in loader.league_dir.iterdir() 
    ...
    for year in selected_years:
        ...
        try:
            ...
            # for birth years.
            try:
                df_info = loader.scan_file("player_information.csv", year=year).select(["Player_ID", "Draft_Year", "Year_Born"]).collect()
